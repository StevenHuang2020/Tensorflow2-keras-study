...
def main():
    ...
    checkpointer = ModelCheckpoint(filepath='./weights/cnnTf2Kernel.hdf5', verbose=1, save_best_only=False)
    history = model.fit(x=x_train, y=y_train, epochs=5,callbacks = [checkpointer])
